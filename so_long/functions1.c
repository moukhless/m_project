...
/*   Updated: 2023/03/03 20:50:13 by amoukhle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (keycode == 13 && is_a_wall(var->width ,var->height - 60, var) == 0)
		key_up(var);
	else if (keycode == 1 && is_a_wall(var->width ,var->height + 60, var) == 0 )
		key_down(var);
	else if (keycode == 2 && is_a_wall(var->width + 60 ,var->height, var) == 0)
		key_right(var);
	else if (keycode == 0 && is_a_wall(var->width - 60 ,var->height, var) == 0)
		key_left(var);
	else if (keycode == 53)
	{
